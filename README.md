...
- #### Follow these steps for installing AudiobookerIII (newer Mac OS X with Apple Music)
  ...
  - Launch **Music**. A **Music** Script menu ![ApplescriptIcon](DocIconImage.png) item displaying the script collection will now be available in the top menu bar. You should see **~AudiobookerIII** in the ![ApplescriptIcon](DocIconImage.png) pull down menu.
...
- #### Follow these steps for installing AudiobookerII (Mac OS X with Apple iTunes)
  ...
  - Launch **iTunes**. An **iTunes** Script menu ![ApplescriptIcon](DocIconImage.png) item displaying the script collection will now be available in the menu bar. You should see **~AudiobookerII** in the ![ApplescrioptIcon](DocIconImage.png) pull down menu.
...
- Select **~AudiobookerIII (AudiobookerII)** from the Script menu ![ApplescriptIcon](DocIconImage.png).
